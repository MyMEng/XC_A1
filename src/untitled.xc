...
// the following game:
//
// An ďLED AntĒ is represented by a position on the clock wheel of the
// XC-1A board. Each ďLED AntĒ is visualised by one active red LED on
...
//
// Defender Ant
// The user controls one ďLED AntĒ by pressing either button A (moving
...
//
// Attacker Ant
// A second ďLED AntĒ is controlled by the system and starts at LED position VI.
...
//COLLISION DETECTOR... the controller process responds to ďpermission-to-moveĒ requests
